...
// Cargo datos de Mamá
// let nomM = localStorage.getItem('nombreMama');
// document.getElementById("nombreM").textContent=nomM;

// Cargo datos de los Hospitales desde un archivo tipo JSON (después se tiene que mejorar a bucle)
